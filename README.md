...
* ✅ Italic Markdown — `*x*` / `_x_` / `***bold-italic***` parse and thread through the compiler to italic font_ids; Helvetica/Times/Courier render real italic, curated fonts fall back to regular (same documented limitation as bold)
